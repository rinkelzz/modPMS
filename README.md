...
## Features Basis-Modul (Version 1.8.3)
...
- **Reservierungsverwaltung** mit eigenem Modul inkl. Historie, Statusverfolgung, Verantwortlichen (erstellt/zuletzt geändert), dynamischen Mehrfachkategorien samt Zimmermengen pro Reservierung, optionaler Zimmerzuweisungen pro Kategorieeintrag (mehrere Zimmer unterschiedlicher Kategorien pro Buchung) und stabiler Live-Suche nach Gästen oder Firmen inklusive Adresseinblendung – die ausgewählte Rate berechnet automatisch Preis pro Nacht und Gesamtpreis mit dem in den Einstellungen gepflegten Mehrwertsteuersatz, die Abreise muss nach der Anreise liegen, pro Zimmer können eigene Aufenthaltszeiträume mit Verfügbarkeitsprüfung hinterlegt werden und die Oberfläche zeigt sofort die Einzelpreise sowie die Gesamtsumme an.
