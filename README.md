...
## Features Basis-Modul (Version 1.5.0)
...
- **Reservierungsverwaltung** mit eigenem Modul inkl. Historie, Statusverfolgung, Verantwortlichen (erstellt/zuletzt geändert) und Volltextsuche nach Gast- bzw. Firmennamen.
