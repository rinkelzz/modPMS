...
## Features Basis-Modul (Version 1.5.2)
...
- **Reservierungsverwaltung** mit eigenem Modul inkl. Historie, Statusverfolgung, Verantwortlichen (erstellt/zuletzt geändert) und stabiler Live-Suche nach Gästen oder Firmen inklusive Adresseinblendung.
