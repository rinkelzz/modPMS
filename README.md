...
## Features Basis-Modul (Version 1.5.6)

- **Dashboard** mit gleitendem 8-Tage-Zimmerkalender (Zimmer auf Y-Achse, Tage auf X-Achse) inklusive bereinigter Kategorien-/Zimmerleiste, kategorieweiser Übersichtszeile (Belegung/Frei/Überbuchungen je Tag), eigener Zimmer- und Überbuchungsdarstellung pro Kategorie sowie flexibler Datums-Navigation (−2 Tage bis +5 Tage).
