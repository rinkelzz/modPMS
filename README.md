...
## Features Basis-Modul (Version 1.5.3)

- **Dashboard** mit gleitendem 8-Tage-Zimmerkalender (Zimmer auf Y-Achse, Tage auf X-Achse) inklusive Kategorie-Summen (gesamt/frei/Überbuchungen), Anzeige der aktuellen Belegung pro Zimmer (Gastnachname bzw. Firmenname), separater Überbuchungszeile je Kategorie sowie flexibler Datums-Navigation (−2 Tage bis +5 Tage).
...
- **Reservierungsverwaltung** mit eigenem Modul inkl. Historie, Statusverfolgung, Verantwortlichen (erstellt/zuletzt geändert), Pflichtauswahl der Zimmerkategorie samt benötigter Zimmeranzahl, optionaler Zimmerzuweisung (Überbuchungslisten) und stabiler Live-Suche nach Gästen oder Firmen inklusive Adresseinblendung.
