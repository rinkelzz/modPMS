...
class MeldescheinManager
{
    ...
    public function createForm(array $data, callable $pdfGenerator): array
    {
        ...
        $stmt = $this->pdo->prepare(
            ...
            . '(form_number, guest_id, reservation_id, guest_name, company_name, purpose_of_stay, arrival_date, departure_date, issued_date, room_label, pdf_path, details_json, created_at, updated_at) '
            . 'VALUES (:form_number, :guest_id, :reservation_id, :guest_name, :company_name, :purpose_of_stay, :arrival_date, :departure_date, :issued_date, :room_label, :pdf_path, :details_json, NOW(), NOW())'
        );
        $stmt->execute([
